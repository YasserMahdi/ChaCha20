...
class Dashboard():
    ...
    def Add(self, widget):
        ...
        if (name == "button"):
            ...
            widget.controller = root.Checkbutton(fram, text=widget.title, variable=widget.value, onvalue=1,
                                                 offvalue=0)  # Creating the widget checkbutton
...
class Create_button:
    ...
    def __init__(self, posX, posY, title="MyButton", length=100,
                 breadth=30):  # constructor setting pos_x,pos_y, width and height 
        self.name = "button"
        self.title = title
...
class Text_area:
    ...
    def __init__(self, posX, posY, length=300, breadth=200,
                 text=""):  # constructor setting pos_x,pos_y , width and height
        self.name = "textarea"
        self.position_X = posX
        self.position_Y = posY
        self.width = length
